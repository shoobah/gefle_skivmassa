...
<div class="the-form">
	...
	{:else}
		<article>
			...
			<p>
				Vi bakom eventet jobbar helt ideellt och är alltså inte avlönade eller tjänar pengar på
				detta. Det innebär en tight budget och ibland har vi inte tillräckligt många händer.
			</p>
			<p>
